  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        {/* Hero Section */}
        <section className="w-full py-8 md:py-16 lg:py-24 xl:py-32 bg-gradient-to-br from-green-50 to-blue-50">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2 max-w-4xl">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 text-base sm:text-lg md:text-xl px-4">
                  Join over 500 successful traders worldwide. Learn proven strategies, get exclusive market insights,
                  and access our expert community. Start your journey from beginner to professional trader.
                </p>
              </div>
        ...
        <section id="about" className="w-full py-8 md:py-16 lg:py-24 bg-white">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8 md:mb-12">
              ...
              <p className="max-w-[900px] text-gray-500 text-base sm:text-lg md:text-xl px-4">
                Trading is the art and science of buying and selling financial instruments to profit from price
                movements. It's one of the most lucrative skills you can learn in today's digital economy.
              </p>
            </div>
        ...
        <section className="w-full py-8 md:py-16 lg:py-24 bg-gray-50">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8 md:mb-12">
              ...
              <p className="max-w-[900px] text-gray-500 text-base sm:text-lg md:text-xl px-4">
                Real results from real students who transformed their lives through trading education.
              </p>
            </div>
          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 text-base sm:text-lg md:text-xl px-4">
                  We provide the most comprehensive trading education with proven strategies, real-time support, and a
                  thriving community.
                </p>
              </div>
            </div>
        ...
        {/* CTA Section */}
        <section className="w-full py-8 md:py-16 lg:py-24 bg-amber-500">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] text-amber-100 text-base sm:text-lg md:text-xl px-4">
                  Join 500+ successful traders and get instant access to our Discord community, proven strategies, and
                  expert mentorship.
                </p>
              </div>
      ...
      <footer className="flex flex-col gap-4 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 text-center sm:text-left">© 2024 Prime Aura. All rights reserved.</p>
